...
/**
 * Таксономия «Разобрать вещи». После объединения гендерных гардеробов в одну
 * «Одежда» полностью совпадает с ITEM_CATEGORIES — вынесено явно для читаемости.
 */
export const RECYCLING_CATEGORIES = [...ITEM_CATEGORIES];

/** Старая категория объявления → новая (одноразовая миграция в БД). */
export const LEGACY_CATEGORY_MAP = {
  'Одежда': 'Одежда',
  'Обувь': 'Одежда',
  'Женский гардероб': 'Одежда',
  'Мужской гардероб': 'Одежда',
