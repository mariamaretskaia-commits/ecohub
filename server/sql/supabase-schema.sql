...
ALTER TABLE item_wants ADD COLUMN IF NOT EXISTS hidden_by_owner_at TIMESTAMPTZ;
ALTER TABLE item_wants ADD COLUMN IF NOT EXISTS hidden_by_buyer_at TIMESTAMPTZ;
