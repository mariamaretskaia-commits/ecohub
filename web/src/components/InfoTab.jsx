    ...
    <div className="px-4 pt-2 pb-8 space-y-4">
      ...
      <div className="card p-5">
        ...
        <ul className="space-y-3">
          ...
          <Thesis
            title="Хочу взять"
            text="Если у автора есть @username – чат откроется сразу. Если нет – бот передаст сообщение."
          />
          <Thesis
            title="Оба жмут /start"
            text="Бот доставляет отклики только тем, кто хотя бы раз открыл @EcoHubBY_bot."
          />
        </ul>
      </div>
